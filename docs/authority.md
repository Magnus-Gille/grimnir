...
| **Operational health record shape, expected-inventory aggregation truth, trace privacy allowlist, and major/minor rollout rules** | `docs/operational-observability-contract.md` plus `docs/operational-observability-v1.schema.json` | Heimdall projections and producer-owned operational emitters |
