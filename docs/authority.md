...
| **Operational health record shape, authority-kind expected-slot derivation, consumer-owned freshness caps, trace privacy allowlist, and major/minor rollout rules** | `docs/operational-observability-contract.md` plus `docs/operational-observability-v1.schema.json` | Heimdall/Brokkr projections and producer-owned operational emitters |
