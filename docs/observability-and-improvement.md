...
| M5 capability ledger, verifiers, and experiment import | Implemented; ground truth partial | Capability truth and admissible Hugin imports are live. `gille-inference#11` and `#13` are closed; their merged mechanisms do not substitute for the still-missing end-to-end production evidence. |
