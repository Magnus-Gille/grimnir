...
[[ "$HUGIN_UNITS" == '[{"name":"hugin","type":"service","scope":"user","boot_enable":true},{"name":"hugin-daily-exam-factory","type":"timer","scope":"user"},{"name":"hugin-experiment-cadence","type":"timer","scope":"user"}]' ]] || {
