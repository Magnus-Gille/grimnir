...
if (key.asymmetricKeyType !== "ed25519" || !Number.isInteger(Number(sequence)) || Number(sequence) < 1 || (previousDigest && !/^sha256:[a-f0-9]{64}$/.test(previousDigest))) throw new Error("Ed25519 public key, positive sequence, and valid previous digest required");
