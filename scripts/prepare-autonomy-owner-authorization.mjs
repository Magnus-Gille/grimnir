...
if (coverage.constitution_digest !== constitution.constitution_digest || coverage.schema_version !== constitution.schema_version) throw new Error("constitution and coverage must be one exact contract epoch");
